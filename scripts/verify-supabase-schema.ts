...
const tables = {
  ...
  email_campaigns: 'id,user_id,status,daily_send_limit,sender_profile_id,total_recipients,sent_count,opened_count,next_run_at',
  email_sending_profiles: 'id,user_id,from_email,sender_name,brand_name,daily_send_limit,is_enabled',
