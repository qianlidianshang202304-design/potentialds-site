    ...
    <div className="bg-transparent">
      ...
      <section className="pt-32 pb-20 px-6 text-center max-w-4xl mx-auto">
        <div className="rounded-3xl border border-zinc-200/60 bg-white/85 px-6 py-12 shadow-[0_24px_50px_-36px_rgba(0,0,0,0.25)] backdrop-blur-xl">
          ...
          {/* --- 百度网盘下载卡片 (新增部分) --- */}
          <div className="bg-orange-50/90 border border-orange-100 p-6 md:p-8 rounded-3xl max-w-md mx-auto shadow-xl shadow-orange-100/50 text-left">
            ...
            <p className="text-[10px] text-orange-500 mt-4 text-center">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white/85 p-8 rounded-3xl shadow-sm border border-zinc-200/60 backdrop-blur-sm">
